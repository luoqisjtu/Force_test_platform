...
namespace DaqInScan01
{
	public class frmDataDisplay : System.Windows.Forms.Form
	{
		...
		private void cmdRead_Click(object sender, System.EventArgs e)
		{
			...
			int Count;
			int PretrigCount;
            MccDaq.CounterTickSize Ticksize = CounterTickSize.Tick20pt83ns;  // not used
            ...
            ULStat = DaqBoard.CConfigScan(CounterNum, MccDaq.CounterMode.StopAtMax, MccDaq.CounterDebounceTime.DebounceNone, 0, MccDaq.CounterEdgeDetection.RisingEdge, Ticksize, CounterNum);
			...
			if(MemHandle == IntPtr.Zero)          // check that a handle to a memory buffer exists
				Application.Exit();
